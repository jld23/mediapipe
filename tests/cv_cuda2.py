...
timers["reading"] = end_read_time - start_read_time
...
#     # add elapsed iteration time
#     timers["pre-process"] = end_pre_time - start_pre_time
...
#     # add elapsed iteration time
#     timers["optical flow"] = end_of - start_of
...
# # add elapsed iteration time
# timers["post-process"] = end_post_time - start_post_time

# # end full pipeline timer
# end_full_time = time.time()

# # add elapsed iteration time
# timers["full pipeline"] = end_full_time - start_full_time
...
# if False:  
    ...
    while True:
        ...
        # add elapsed iteration time
        timers["reading_gpu"] = end_read_time - start_read_time
    ...
    # add elapsed iteration time
    timers["optical flow_gpu"] = end_of - start_of
    ...
    # add elapsed iteration time
    timers["post-process_gpu"] = end_post_time - start_post_time

    # end full pipeline timer
    end_full_time = time.time()

    # add elapsed iteration time
    timers["full pipeline_gpu"] = end_full_time - start_full_time
